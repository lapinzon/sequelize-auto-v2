    ...
    async.each(
      ...
      function (table, _callback) {
        ...
        if (!self.options.typescript) {
          ...
          text[table] += "var DataTypes = require('sequelize').DataTypes;\n\n"
          text[table] += 'module.exports = function() {\n';
          text[table] += spaces + "return define('" + tableName + "', {\n";
        } else {
              ...
              if (_.isString(defaultVal)) {
                ...
                if (_.endsWith(defaultVal, '()')) {
                  ...
                  if (
                    ...
                    //TODO: llega '(getdate())', por ahora forzar a null.
                    // No parece tener sentido emular valores default de base de datos aquí
                    defaultVal = null;
                  } else {
